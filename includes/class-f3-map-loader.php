 ...
 * @subpackage Windsor_Strava_Athlete/includes
 */
...
class F3_Map_Loader {
	...
	/** 
	 * The array of shortcodes for showing the map.
	*/
	...
	public function add_shortcode( $tag, $component, $callback) {
	    $this->shortcodes = $this->add( $this->shortcodes, $tag, $component, $callback, 0, null );
	}
